...
# 已修复：DTS路径缺失、Feeds断连、PHP依赖、Terminal终端报错
# ============================================================
set -e
...
# --- 2. DTS 物理合并修复 (解决 DTS Include 找不到的 Error 1) ---
...
# --- 3. Feeds 强制自愈 (延续成功同步逻辑) ---
echo ">>> [修复2] 正在重构插件源并强制同步..."
...
# --- 5. 配置合并与静默加固 (解决 Error opening terminal) ---
echo ">>> [修复3] 强制执行静默配置生成..."
...
# 绝杀：确保没有任何环节会弹出 menuconfig
make defconfig

echo "✅ [任务完成] V16.5 全量修复项已锁定！"
